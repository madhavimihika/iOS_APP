...
struct LightItUpViewLevel1: View {
    ...
    private let litWindow = 1.5
    private let levelColor: Color = .green
    private let levelName = "Level 1"
    ...
    var body: some View {
        ...
        .padding(.vertical)
        .navigationTitle("Light It Up L1")
    ...
    private var gameInfoView: some View {
        VStack(alignment: .leading, spacing: 8) {
            Text("0-15 seconds • 3 cards in a row")
                .font(.subheadline)
                .foregroundColor(.secondary)
            Text("• 1.5 seconds to tap the lit card")
                .font(.caption)
                .foregroundColor(.secondary)
            Text("• \(roundDuration)s round • Lives: \(lives)/\(maxLives)")
                .font(.caption)
                .foregroundColor(.secondary)
            Text("• Easiest level - get comfortable!")
                .font(.caption)
                .foregroundColor(levelColor)
